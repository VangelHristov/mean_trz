(function errorMessagesModule() {
	...
	angular
		...
		.constant('errorMessages', {
			...
			invalidDateFormat       : 'Датата трябва да бъде във формат' +
			' дд.мм.гггг. На пример 03.03.2017.',
			missingRequiredFields   : 'Попълнете всички задължителни полета.',
			invalidPostalCode       : 'Пощенският код трябва да бъде 4 цифрен'
		});
}());