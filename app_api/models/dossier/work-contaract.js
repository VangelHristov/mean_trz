...
const
  ...
  workContractSchema = new Schema({
      dossier                  : {type: objectId, ref: 'Dossier', required: [true, errorMessages.missingDossierId]},
      typeInsured              : {
          type    : String,
      ...
      contractNumber           : {type: String, required: [true, errorMessages.missingContractNumber]},
      signingDate              : {type: Date, required: [true, errorMessages.missingSigningDate]},
      startingDate             : {type: Date, required: [true, errorMessages.missingStartingDate]},
      principalSalary          : {
          type    : Number,
          required: [true, errorMessages.missingSalary],
          min     : [minWage, errorMessages.salaryAmountBelowMinimum]
      },
      contractLengthInMonths   : {type: Number, min: [1, errorMessages.invalidContractLength]},
      workHours                : {
          type: Number,
      ...
      codeEconomicActivity     : {
          ...
          match   : [patterns.codeEconomicActivity, errorMessages.invalidCodeEconomicActivity]
      },
      leaveNoticeLengthInDays  : {type: Number, min: [0, errorMessages.invalidLEaveNoticeLength]},
